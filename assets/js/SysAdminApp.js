			...
			<Card.Body>
			    {showForm &&
				 ...
				 <Card.Body>
				     ...
				     <Form.Group className="mb-3">
                                         ...
                                         <Form.Text>URL or domain name of system to share with.<span className="required">*</span></Form.Text>
				     ...
				     <Form.Group className="mb-3">
					 <Form.Label className="mb-0">Share Key (outgoing)</Form.Label>
					 ...
					 {invalidOutgoing &&
					  <Form.Text className="error">
					      Either this field OR incoming API key is required.
                                     ...
                                     <Form.Group className="mb-3">
                                         <Form.Label className="mb-0">Allow Transfers from (incoming)</Form.Label>
                                         <Form.Text>Last 4 digits of API key to allow case transfer requests</Form.Text>
				...
				return (
					...
					<Card bg={c.disabled ? "danger" : "light"} text={c.disabled ? "white" : "dark"} >
						...
						<div><b>Key:</b>{" "}{c.external_key}</div>
						{c.incoming_api_key &&
						 <div><b>Incoming:</b>{" "}******{c.incoming_api_key}</div>
						}
