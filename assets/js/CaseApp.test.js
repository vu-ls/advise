...
describe("Case App", () => {
  ...
  it("should render search cases by default", async () => {
      ...
      const history = createMemoryHistory({initialEntries:["/advise/cases"]});
      ...
      render(
          <MemoryRouter initialEntries={["/advise/cases", "/advise/cases/:id"]} initialIndex={0}>
              <CaseApp />
          </MemoryRouter>
      );
	...
	mock.onGet("http://localhost:8000/advise/api/cases/312650/").reply(200, mockcasejson);
	mock.onGet("http://localhost:8000/advise/api/case/312650/participants/?role=owner").reply(200,
            [
                {
                    id: 125,
                    name: "emily",
	...
	mock.onGet("http://localhost:8000/advise/api/case/312650/user/").reply(200,
									       {
										   user: {
                        id: 1,
                        name: "emily",
	...
	mock.onGet("http://localhost:8000/advise/api/cases/123456/").reply(404, new Error("not found"));
	...
	mock.onGet("http://localhost:8000/advise/api/cases/312650/").reply(200, mockcasejson);
	mock.onGet("http://localhost:8000/advise/api/cases/312650/status/").reply(200, []).onAny().reply(200, []);
	...
	mock.onGet("http://localhost:8000/advise/api/cases/123456/").reply(403, new Error("Forbidden"));
        render(
            <MemoryRouter initialEntries={["/advise/cases/123456"]}>
              <CaseApp />
            </MemoryRouter>
    ...
    it("should render err if permission denied on case status", async () => {
       mock.onGet("http://localhost:8000/advise/api/cases/123456/").reply(403, new Error("Permission Denied"));
